...
/// Tutor login page with the **mint green → teal** Joyful UI palette.
...
class _TutorAuthPageState extends State<TutorAuthPage>
  ...
  Future<void> _handleLogin() async {
    ...
    final success = await auth.login(email, password, 'tutor');

    if (!mounted) return;
    setState(() => _isSubmitting = false);

    if (success) {
      _showSnackbar('Login berhasil! Selamat mengajar 🎉');
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFF0FFF4), Color(0xFFE0F9ED)],
          ),
        ),
        child: SafeArea(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [_mint, _teal]),
                  ...
                  Text(
                    'Bantu siswa raih prestasi terbaik 🌟',
                    style: GoogleFonts.nunito(
                      fontSize: 14,
